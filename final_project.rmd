...
### Data Cleaning
To start, looking at the variables "wto", "alliance_US", "alliance_RU", "conflict", "conflict_intensity", and "conflict_type", these variables are categorical but are represented as numbers. We will need to convert these variables to categorical variables to make it easier to work with and understand the data.
...
```{r}
fdi_correlation <- fdi[,c("fdi_per_gdp", "alliance_US")]
cor(fdi$fdi_per_gdp, fdi$alliance_US)
```
